...
<html lang="ko">
	...
	<script src="/team/resources/js/main.js"></script>
	<script src="/team/resources/js/jquery-2.1.3.min.js"></script>
	<script src="/team/resources/dist/aos.js"></script>
 ...
 /* 메인페이지 콘솔 로그 확인 */
	...
	<link rel="icon" href="/team/resources/images/Favicon.png">
	<link rel="stylesheet" href="/team/resources/css/main.css">
	<link rel="stylesheet" href="/team/resources/dist/aos.css" />
	<link rel="stylesheet"
...
<!-- snb 끝 -->
		...
		<div class="slideshow-container">
			...
			<div class="mySlides fade">
				<img src="/team/resources/images/main_banner1.png" alt="" />
			...
			<!--배너2-->
			<div class="mySlides fade">
				<img src="/team/resources/images/main_banner2.png" alt="" />
				<div class="text">
			...
			<!--배너3-->
			<div class="mySlides fade">
				<img src="/team/resources/images/main_banner3.png" alt="" />
		...
		<div class="menu_wrap">
			<div class="menu_container">
				<ul class="menu_box aboutinner aos-item" data-aos="fade-up">
					<li>
						<img src="/team/resources/images/sport_icon.png" alt="sport" onclick="location.href='sport_list.do'"> 
						<a href="#">운동&#47;스포츠</a>
					</li>
	
					<li><img src="/team/resources/images/music_icon.png"
						alt="sport" onclick="location.href='sport_list.do'"> <a
						href="#">음악&#47;악기</a></li>
	
					<li><img src="/team/resources/images/crafts_icon.png"
						alt="sport" onclick="location.href='sport_list.do'"> <a
						href="#">공예&#47;만들기</a></li>
	
					<li><img src="/team/resources/images/self_icon.png"
						alt="sport" onclick="location.href='sport_list.do'"> <a
						href="#">자기계발</a></li>
	
					<li><img src="/team/resources/images/game_icon.png"
						alt="sport" onclick="location.href='sport_list.do'"> <a
						href="#">게임&#47;오락</a></li>
	
					<li><img src="/team/resources/images/gathering_icon.png"
						alt="sport" onclick="location.href='sport_list.do'"> <a
						href="#">사교</a></li>
				</ul>
			</div>
	        ...
	        <div>등록된 제품이 없습니다.</div>
				...
				<div class="con_wrapper">
					<div class="con_box aboutinner aos-item best" data-aos="fade-up" onclick="">
						<img src="/team/resources/images/thumbnail.png" alt="thumbnail">
						<h2>프로그램 타이틀</h2>
						<p>30,000원</p>
						<span>1인당</span>
					</div>
	        ...
	        <div>등록된 제품이 없습니다.</div>
				...
				<div class="con_wrapper">
					<div class="con_box aboutinner aos-item" data-aos="fade-up"
						onclick="">
						<img src="/team/resources/images/thumbnail2.png" alt="thumbnail">
						<h2>프로그램 타이틀</h2>
						<p>30,000원</p>
						<span>1인당</span>
					</div>
		...
		<div class="sub_banner_container menu_box aboutinner aos-item"
			...
			<div class="sub_baneer_box">
				...
				<img src="/team/resources/images/main_sub_banner.png" alt="서브배너"> 
				<a href="#">더
					알아보기</a>
			</div>
		</div>
	    ...
	    <div>등록된 제품이 없습니다.</div>
				...
				<div class="con_wrapper">
					<div class="con_box aboutinner aos-item" data-aos="fade-up"
						onclick="">
						<img src="/team/resources/images/thumbnail3.png" alt="thumbnail">
						<h2>프로그램 타이틀</h2>
						<p>30,000원</p>
						<span>1인당</span>
					</div>
