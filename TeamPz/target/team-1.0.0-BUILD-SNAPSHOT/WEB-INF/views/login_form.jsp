  ...
  <title>로그인 페이지</title>
    ...
    function login() {
  	...
  	//	console.log("로그인 요청:", username, password);
	    ...
	    // URL과 파라미터 구성
	    let url = "Login.do";
	    let param = "username=" + encodeURIComponent(username) + 
                "&password=" + encodeURIComponent(password);

        // AJAX 요청
    //	console.log("여기까지 오나 ?:", username, password);
    ...
    function loginResult() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            if (result === "success") {
                alert("로그인 성공");
               // console.log("로그인 요청: username = " + username + ", password = " + password);
...
<!--헤더 시작-->
    ...
    <div class="login-container">
        ...
        <div class="social-login">
            <a href="naver_form.do"><img src="resources/images/naver.png" alt="네이버 로그인" class="social-icon"></a>
            <a href="kakao_form.do"><img src="resources/images/kakao.png" alt="카카오톡 로그인" class="social-icon"></a>
        </div>
    </div>
