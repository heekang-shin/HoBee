					...
					<table>
						...
						<c:forEach var="vo" items="${user_list}" varStatus="status">
							<tr>
								...
								<td width="15%" class="line">
									<a href="user_detail.do?user_Id=${vo.user_Id}">${vo.join_date}</a>
								</td>
								<td width="10%" class="line">
									<a href="user_detail.do?user_Id=${vo.user_Id}">${vo.lv}</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
