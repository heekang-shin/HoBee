                ...
                <form enctype="multipart/form-data">
                    <div class="form-container">
                        ...
                        <div class="form-box">
                            ...
                            <input type="text" name="hb_title" value="${vo.hb_title}">
                        </div>

						<!-- 가격 -->
                        <div class="form-box">
						    <label>가격 <b class="req">*</b></label>
						    <input type="text" name="hb_price"
						           value="<fmt:formatNumber value='${vo.hb_price}' pattern='#,##0' />"
                        ...
                        <div class="form-box">
                            ...
                            <input type="number" name="hb_tot_num" value="${vo.hb_tot_num}"> &nbsp;명
                        </div>
                        ...
                        <div class="form-box addr-container">
                            ...
                            <div class="addr-box">
                                ...
                                <input type="text" id="sample6_postcode" value="${vo.postcode}">
                                <input type="text" id="sample6_address" value="${vo.address}">
                                <input type="text" id="sample6_detailAddress" value="${vo.detailAddress}">
                                <input type="text" id="sample6_extraAddress" value="${vo.extraAddress}">
                            </div>
                        ...
                        <div class="form-box">
                            ...
                            <div class="upload-box">
                                <div class="image-preview" id="thumbnail-preview">
                                    <img src="/hobee/resources/images/upload/${vo.s_image}" alt="썸네일 미리보기">
                                </div>
                        ...
                        <div class="form-box">
                            ...
                            <div class="upload-box">
                                <div class="image-preview" id="l-thumbnail-preview">
                                    <img src="/hobee/resources/images/upload/${vo.l_image}" alt="대표이미지 미리보기">
                                </div>
                                <div class="upload-inner">
                        ...
                        <div class="form-box">
                            ...
                            <div class="upload-box">
                                <div class="image-preview" id="in-thumbnail-preview">
                                    <img src="/hobee/resources/images/upload/${vo.in_image}" alt="상세이미지 미리보기">
                                </div>
                                <div class="upload-inner">
